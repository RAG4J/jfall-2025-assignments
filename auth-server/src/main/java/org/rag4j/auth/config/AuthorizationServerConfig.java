...
/**
 * OAuth2 Authorization Server Configuration for favourites Application.
 * <p>
...
public class AuthorizationServerConfig {
    ...
    public RegisteredClientRepository registeredClientRepository(PasswordEncoder passwordEncoder) {
        ...
        RegisteredClient webAppClient = RegisteredClient.withId(UUID.randomUUID().toString())
                ...
                .scope("favourites.read")
                .scope("favourites.write")
                .clientSettings(ClientSettings.builder()
                        .requireAuthorizationConsent(true) // Enable consent for demo
                        .build())
        ...
        // Favourites MCP Client - Client Credentials Flow (Server-to-Server)
        RegisteredClient locationMcpClient = RegisteredClient.withId(UUID.randomUUID().toString())
                .clientId("favourites-mcp")
    ...
    private void customizeProviderConfiguration(OidcProviderConfiguration.Builder builder) {
        builder.scopes(scopes -> {
            ...
            scopes.add("favourites.read");
            scopes.add("favourites.write");
        });
    }
