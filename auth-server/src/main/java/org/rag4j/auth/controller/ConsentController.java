package org.rag4j.auth.controller;
...
public class ConsentController {
    ...
    private String getClientDisplayName(RegisteredClient client) {
        ...
        return switch (clientId) {
            case "favourites-web" -> "Favourites Web Application";
            case "favourites-mcp" -> "Favourites MCP Server";
    ...
    private String getScopeDescription(String scope) {
        return switch (scope) {
            ...
            case "favourites.read" -> "View your favourites and preferences";
            case "favourites.write" -> "Create, update, and delete your favourites";
